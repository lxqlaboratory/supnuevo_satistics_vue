<template>
  ...
  <div class="prologin-container">
    <div class="header">
      ...
      <!--标题图-->
      <!--能源动力-->
      <img style="width: 300px;height: 50px;" src="/login/name.png">
      <!--软件-->
    ...
    <div class="main-content">
      ...
      <div>
        <!--背景更换-->
        <!--能源动力-->
        <img class="bgflux" src="/login/backgroud.png">
        <!--软件-->
    ...
    <div class="notice">
      ...
      <!--文字更换-->
      <div class="notice-title">西班牙超市</div>
    ...
    <div class="login-bottom">西班牙超市</div>
  </div>
